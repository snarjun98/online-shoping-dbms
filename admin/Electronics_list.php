...
<body>
  <?php include("include/header.php");?>
	...
	<h1><b>ELectronics_List</b></h1></div><br>
...
$result=mysqli_query($conn,"SELECT productid,productimg,productname,productprice FROM component WHERE cat='EM' OR cat='EL' OR cat='ET'")or die ("query 2 incorrect.....");
...
<a class=' btn btn-default btn-danger' href='Electronics_list.php?productid=$product_id&action=delete'>Delete</a>
</td></tr>";
}
