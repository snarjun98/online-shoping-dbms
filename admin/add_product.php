...
mysqli_query($conn,"insert into component (cat,productname,productprice, productpprice, productimg,descption) values ('$product_type','$product_name','$price','$c_price','$pic_name','$details')") or die ("query incorrect");
...
<div class="input-group">
      <div class="input-group-addon">Rs</div>
      <input type="text" class="form-control" name="c_price" id="c_price"  placeholder="0.00" required></div>
<br>
        ...
        <div class="well">
<h3>Category</h3>
<input type="text" name="product_type" id="product_type" class="form-control" placeholder="Cat">
</div>
</div>
<div align="center">
