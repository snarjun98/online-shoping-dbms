...
$result=mysqli_query($conn,"SELECT productid,productimg,productname,productprice FROM component WHERE cat='CM' OR cat='CG'")or die ("query 2 incorrect.....");
...
<a class=' btn btn-default btn-danger' href='clothes_list.php?productid=$product_id&action=delete'>Delete</a>
</td></tr>";
}
