...
$result=mysqli_query($conn,"SELECT productid,productimg,productname,productprice FROM component WHERE cat='S' ")or die ("query 2 incorrect.....");
...
<a class=' btn btn-default btn-danger' href='sports_list.php?productid=$product_id&action=delete'>Delete</a>
</td></tr>";
}
