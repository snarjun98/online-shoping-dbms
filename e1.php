...
<div style="background-color: black;color: #FFFFFF;padding: 0px;alignment: center" >
    <p> <center><h2><b style="font-family:'Segoe UI Symbol',fantasy;font-size: 48px;">ELECTRONICS</b></h2></center></p>
</div>
<div class="container">
    <div class="row text-center py-5">
        ...
        $resultset=$conn->query("SELECT * FROM component WHERE cat='EM' OR cat='ET' OR cat='El'");
